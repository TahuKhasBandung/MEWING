...
data_ip="https://raw.githubusercontent.com/TahuKhasBandung/permision/main/permission"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "\033[42m          RIRI STORE AUTOSCRIPT          \033[0m"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    echo -e ""
    ...
    echo -e "      ${GREEN}Telegram${NC} t.me/riristore"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
